...
def doLogin(request):
    ...
    elif user.user_type == CustomUser.ADVISOR:
...
def doRegistration(request):
    ...
    if user_type is None:
        messages.error(
            request, "Please use valid format for the email id: '<username>.<student|advisor|admin>@<college_domain>'")
        return render(request, 'registration.html')
    ...
    if user_type == CustomUser.ADVISOR:
