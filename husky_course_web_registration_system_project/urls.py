...
urlpatterns = [
    ...
    path('student_view_registration/', StudentViews.student_view_registration,
         name="student_view_registration"),
    path('student_modify_registration/', StudentViews.student_register_course,
         name="student_register_course"),
    #     path('student_register_course_save/', StudentViews.student_register_course_save,
    #          name="student_register_course_save"),
    path('student_add_course/<course_id>', StudentViews.student_add_course,
         name="student_add_course"),
    path('student_drop_course/<course_id>', StudentViews.student_drop_course,
    ...
    path('staff_message/', StaffViews.staff_message, name="staff_message"),
    path('staff_message_save/', StaffViews.staff_message_save,
         name="staff_message_save"),
    path('manage_student_registration/', StaffViews.manage_student_registration,
         name="manage_student_registration"),
    path('approve_student_registration/<student_id>', StaffViews.approve_student_registration,
         name="approve_student_registration"),
    path('decline_student_registration/<student_id>', StaffViews.decline_student_registration,
         name="decline_student_registration"),
    ...
    path('add_campus/', HodViews.add_campus, name="add_campus"),
    path('add_campus_save/', HodViews.add_campus_save, name="add_campus_save"),
    path('manage_campus/', HodViews.manage_campus, name="manage_campus"),
    path('edit_campus/<campus_id>/', HodViews.edit_campus, name="edit_campus"),
    path('edit_campus_save/', HodViews.edit_campus_save, name="edit_campus_save"),
    path('delete_campus/<campus_id>/',
         HodViews.delete_campus, name="delete_campus"),
    path('add_classroom/', HodViews.add_classroom, name="add_classroom"),
    path('add_classroom_save/', HodViews.add_classroom_save,
         name="add_classroom_save"),
    path('manage_classroom/', HodViews.manage_classroom, name="manage_classroom"),
    path('edit_classroom/<classroom_id>/',
         HodViews.edit_classroom, name="edit_classroom"),
    path('edit_classroom_save/', HodViews.edit_classroom_save,
         name="edit_classroom_save"),
    path('delete_classroom/<classroom_id>/',
         HodViews.delete_classroom, name="delete_classroom"),
    ...
    path('edit_teacher/<teacher_id>/',
         HodViews.edit_teacher, name="edit_teacher"),
    path('edit_teacher_save/', HodViews.edit_teacher_save,
         name="edit_teacher_save"),
    path('delete_teacher/<teacher_id>/',
         HodViews.delete_teacher, name="delete_teacher"),
    ...
    path('edit_department/<department_id>/',
         HodViews.edit_department, name="edit_department"),
    path('edit_department_save/', HodViews.edit_department_save,
         name="edit_department_save"),
    path('delete_department/<department_id>/',
         HodViews.delete_department, name="delete_department"),
]
